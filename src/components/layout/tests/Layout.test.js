...
describe('Component: Layout', () => {
  ...
  it('should render a route that does not specify a layout', () => {
    ...
    expect(findRouteByPath.default).toHaveBeenLastCalledWith(
      '/default-layout',
      undefined,
      undefined,
    );
  ...
  it('should render a route that does not specify a title', () => {
    ...
    expect(findRouteByPath.default).toHaveBeenLastCalledWith('/no-title', undefined, undefined);
    expect(wrapper).toMatchSnapshot();
  });
});
